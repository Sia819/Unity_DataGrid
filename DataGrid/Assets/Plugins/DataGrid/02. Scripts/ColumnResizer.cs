...
namespace UIExtension.ListView
{
    public class ColumnResizer : MonoBehaviour, IDragHandler, IBeginDragHandler
    {
        ...
        private void Start()
        {
            ...
            resizerButton.OnClickAsObservable()
                .Buffer(resizerButton.OnClickAsObservable().ThrottleFirst(TimeSpan.FromSeconds(0.7f)))
                .Where(x => x.Count >= 2)
        ...
        {
            // TODO : 모든 rows 기준의 최대 preferredWidth로 수정
        }
